...
<![endif]-->
<style>
.ttr_comment_author{width : <?php echo get_option('ttr_avatar_size')."px";?>;}
<?php $avtar = get_option('ttr_avatar_size') + 10;?>
...
<?php echo theme_nav_menu('ttr_','primary','menu',True,True,False,True);?>
</ul>
</div>
</div>
</div>
